...
{
    public class CharacterCustomizationMetadataComponent : IComponent
    {
        private readonly IDBCDStorageProvider _dbcdStorageProvider;

        public CharacterCustomizationMetadataComponent(IDBCDStorageProvider storageProvider)
        {
            _dbcdStorageProvider = storageProvider;
        }

        public CharacterCustomizationMetadata? GetCharacterCustomizationMetadataForCharacter(int characterModelId)
        {
            // Load DBC Data
            ...
            var result = new CharacterCustomizationMetadata();

            result.ModelMaterials = _dbcdStorageProvider["ChrModelMaterial"]
            ...
            {
                result.TextureSections.Add(new()
                {
