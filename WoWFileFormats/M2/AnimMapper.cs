namespace WoWFileFormats.M2
{
	...
	License: MIT
    */
    internal static class AnimMapper
    {
        private static Dictionary<int, string> _animMap = new()
        {
            { 0, "Stand" },
            { 1, "Death" },
            { 2, "Spell" },
        ...
        {
            if (_animMap.TryGetValue(animId, out var value))
            {
                return value;
            }
            return "UnknownAnim_" + animId;
        }
    }
}
